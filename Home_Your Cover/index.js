        ...
        '<div id="tooltip_toc" class="floar_r toolhover">' +
          ...
          //'<span id="r_par"><p class="t_paragraph">What type of cover do you need?</p></span>'+
           '<dl id="typeOfCoverMessageAnchor">'+
                '<dt class="radio-dt-spacer">Would like to add accidental damage cover to your policy</dt>'+
            ...
            '<dl id="buildingsAccidentDamageCoverMessageAnchor">'+
                ...
                '<dd id="specified-radio">'+
                    '<fieldset>'+
                        ...
                        '<label for="buildingsCovers_adc" id="label_buildingsCovers_adc" class="bc_seg_label active_sellection">'+
                            '<span id="radio_buildingsCovers_adc">'+
                                '<input type="radio" name="buildingsCoversType" id="buildingsCovers_adc" value="ADC" checked="checked">'+ 
                            '</span>'+
                            '<span id="description_buildingsCovers_adc">Yes</span>'+
                        '</label>'+
                        '<label for="buildingsCovers_sc" id="label_buildingsCovers_sc" class="bc_seg_label">'+
                            '<span id="radio_buildingsCovers_sc">'+
                                '<input type="radio" name="buildingsCoversType" id="buildingsCovers_sc" value="SC">'+ 
                            '</span>'+
      ...
      '</div>'; 
        ...
        function coverSelectionCookie(){
            ...
            if (document.cookie.indexOf("contentsCovers_adc") >= 0) {
                ...
                $('#cadc #contentssCovers_adc').attr('checked',true);
        ...
        '<div id="cadc" class="toolhover">'+
            '<dl id="contentsAccidentDamageCoverMessageAnchor">'+
                '<dt class="radio-dt-spacer">Would like to add contents accidental damage cover to your policy</dt>'+
                '<dd id="specified-radio">'+
                    '<fieldset>'+
                        '<legend>Would like to add contents accidental damage cover to your policy</legend>'+
                        '<label for="contentsCovers_adc" id="label_contentsCovers_adc" class="cc_seg_label active_sellection">'+
                            '<span id="radio_contentsCovers_adc">'+
                                '<input type="radio" name="contentsCoversType" id="contentsCovers_adc" value="CADC" checked="checked">'+ 
                            '</span>'+
                            '<span id="description_contentsCovers_adc">Yes</span>'+
                        '</label>'+
                        '<label for="contentsCovers_sc" id="label_contentsCovers_sc" class="cc_seg_label">'+
                            '<span id="radio_contentsCovers_sc">'+
                                '<input type="radio" name="contentsCoversType" id="contentsCovers_sc" value="CSC">'+ 
                            '</span>'+
