function lifeInsuBanner (){    
    ...
    if (selector) {
        var lifeInsuranceBG = "https://cro-kruthi.s3-us-west-2.amazonaws.com/GettyImages-888063900.jpg"; //change this to have different background image 
        var LG_description = 'Help protect your family’s future with <b>Life Insurance</b> from £6 per month'; 
        //var LG_bold_promo_text = 'Free £75';
        var LG_promo_text = '£75 M&S or Amazon Gift Card to say thanks for getting a policy.';
        var LG_condition_text = 'Available after your policy’s been live for 6 months. T&Cs apply';
        ...
        '.promo_img_div{ display:flex; position: relative; } .promo { color: #CA2565; margin: 20px 0px -5px 0px;} .boldPromo{ font-size:30px; } .description{ margin-left: 10px;} .CTA_wrapper { margin-top: 30px; } .large_text > div { font-size:1.4rem; line-height:1.2; font-weight: 700;} #lifeInsuarBGimage { margin-left: 20px; margin-right: 20px; }'+
        ...
        '@media only screen and (max-width:767px){.banner_content {flex-flow:column} #lifeInsuarBGimage { margin-left: 0px; margin-right: 0px; } .boldPromo{ font-size: 25px; } .large_text{ font-size: 1.3em; line-height: 1.6rem; margin: 8px 0px; }.large_text > div {font-size: 1rem; line-height: 1.1; margin-top: 20px; } .CTA_wrapper { margin-top: 10px; }}';

        var incomingDiv = '<div class="box lifeInsuranceBanner"><div class="banner_content"> <div class="promo_img_div"><div id="lifeInsuarBGimage"></div></div><div class="description"><div class="large_text">'+ LG_description +'</div><div class="providers"> Provided by Legal & General </div><div class="CTA_wrapper"><a href="#" class=" button is-link is-rounded">Get a quote</a></div><div class="promo large_text"><div>'+ LG_promo_text +'</div></div><div id="sub-text">'+ LG_condition_text +'</div></div></div></div>';
